...
abstract class $AlertModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String message, AlertType type, int? code});
}
...
class _$AlertModelImpl implements _AlertModel {
  const _$AlertModelImpl(
      {required this.message, required this.type, this.code});
  ...
  @override
  String toString() {
    return 'AlertModel(message: $message, type: $type, code: $code)';
  }
