...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AlertModel alert) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AlertModel alert)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Authenticated implements AuthState {
  const factory Authenticated({required final User? user}) =
      _$AuthenticatedImpl;
...
class _$ErrorImpl implements Error {
  const _$ErrorImpl({required this.alert});
  ...
  @override
  String toString() {
    return 'AuthState.error(alert: $alert)';
  }
...
abstract class Error implements AuthState {
  const factory Error({required final AlertModel alert}) = _$ErrorImpl;
